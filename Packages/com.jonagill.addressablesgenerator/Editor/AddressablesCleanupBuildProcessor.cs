...
namespace AddressablesGenerator
{
    ...
    /// but OnPostprocessBuild() doesn't get invoked if a build errors or gets canceled (pre-Unity 6.3), which can leave us in a bad state
    /// </summary>
    public class AddressablesCleanupBuildProcessor : BuildPlayerProcessor
    {
